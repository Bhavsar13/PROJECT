        ...
        <header>
            <div class="topbar navbar-fixed-top">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. 0123456789</p>
                    ...
                    echo ' <p class="pull-right login"><a title="View Notification(s)" href="'.web_root.'applicant/index.php?view=notification"> <i class="fa fa-bell-o"></i> <span class="label label-success">'.$notif.'</span></a> | <a title="View Message(s)" href="'.web_root.'applicant/index.php?view=message"> <i class="fa fa-envelope-o"></i> <span class="label label-success">'.$msg.'</span></a> | <a title="View Profile" href="'.web_root.'applicant/"> <i class="fa fa-user"></i> Howdy, '. $appl->FNAME. ' '.$appl->LNAME .' </a> | <a href="'.web_root.'logout.php">  <i class="fa fa-sign-out"> </i>Logout</a> </p>';
                            ...
                            <p class="pull-right login">
                                <a href="<?php echo web_root; ?>admin/" class="nav-link"><i class="fa fa-lock"></i>ADMIN</a>
                        ...
                        <a class="navbar-brand" href="<?php echo web_root; ?>">
                            ...
                            <div class="navbar-collapse collapse ">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="dropdown">
                                        <a href="#" data-toggle="dropdown" class="dropdown-toggle">Internship Search <b class="caret"></b></a>
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="<?php echo web_root; ?>index.php?q=search-company">Internship By Company</a></li>
                                            <li><a href="<?php echo web_root; ?>index.php?q=search-function">Internship By Category</a></li>
                                            <li><a href="<?php echo web_root; ?>index.php?q=search-jobtitle">Internship By Title</a></li>
                              ...
                              <li><a href="#">Job for Men</a></li> -->
                                    ...
                                    <li class="dropdown <?php  if(isset($_GET['q'])) { if($_GET['q']=='category'){ echo 'active'; }else{ echo ''; }}  ?>">
                                        <a href="#" data-toggle="dropdown" class="dropdown-toggle">Popular Internship <b class="caret"></b></a>
                                        <ul class="dropdown-menu">
                                            <?php 
                            ...
                            ?>
                                ...
                                <a class="navbar-brand" href="<?php echo web_root; ?>index.php"> <img src="<?php echo web_root; ?>/plugins/home-plugins/img/logo.jpg" alt="logo" width="150" height="50" /> </a>
                            </div>
                    </div>
                </div>
        </header>
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="widget">
                            ...
                            <address>
                                ...
                                470 Bourke Street<br>
                                Melbourne, 3000
                            </address>
                            <p>
                                <i class="icon-phone"></i> 0123456789 <br>
                                <i class="icon-envelope-alt"></i> atmc@gmail.com
                            </p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <ul class="social-network">
                                <li><a href="https://www.facebook.com/ATMCSOCIAL/" data-placement="top" title="Facebook"><i class="fa fa-facebook"></i></a></li>
                                <li><a href="https://www.instagram.com/atmc.social/" data-placement="top" title="Instagram"><i class="fa fa-instagram"></i></a></li>
                                <li><a href="https://au.linkedin.com/company/atmc-education" data-placement="top" title="Linkedin"><i class="fa fa-linkedin"></i></a></li>
