     ...
     <div class="modal-dialog">
         <div class="modal-content">
             ...
             <div class="modal-body hold-transition login-page">
                 ...
                 <div class="login-box">
                     <div class="login-box-body" style="border: solid 1px #ddd;padding: 35px;min-height: 350px;">
                         ...
                         <a href="<?php echo web_root; ?>index.php?q=reset">I forgot my password</a><br>
             ...
             <div class="modal-footer">
                 <button class="btn btn-default" data-dismiss="modal">Close</button> <button class="btn btn-primary" name="btnlogin" id="btnlogin">Login</button>
             </div>
             <!-- </form> -->
         </div><!-- /.modal-content -->
     </div><!-- /.modal-dialog -->
